...
dragula([$('left-copy-1tomany2'), $('right-copy-1tomany')], {
	  copy: function (el, source) {
	    return source === $('left-copy-1tomany2');
	  },
	  accepts: function (el, target) {
	    return target !== $('left-copy-1tomany2');
	  }
	});

dragula([$('left-copy-1tomany3'), $('right-copy-1tomany')], {
	  copy: function (el, source) {
	    return source === $('left-copy-1tomany3');
	  },
	  accepts: function (el, target) {
	    return target !== $('left-copy-1tomany3');
	  }
	});
