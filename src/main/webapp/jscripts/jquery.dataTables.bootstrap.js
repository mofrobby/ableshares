...
$.extend( true, $.fn.dataTable.defaults, {
	"sDom": "<'row-fluid'f"+vFormatCopyButtons+"r>t<'row-fluid'lipr>",
...
if ( $.fn.DataTable.TableTools ) {
	...
	$.extend( true, $.fn.DataTable.TableTools.classes, {
		...
		"buttons": {
			"normal": "DTTT_button btn btn-small",
			"disabled": "DTTT_disabled disabled"
		},
		"collection": {
