function refreshMembers(dt, dataList, fntSmall, fntMini) {
	
	if (!dt)
		var dt = document.fraMembers.document.all.dataTable
	if (!dataList)
		var dataList = memberList
	if (!fntSmall)
	...
	for (var i=0; i < dataList.data.length; i++) {
		...
		tempRow.id = dataList.data[i][0];
		// name
		tempRow.insertCell()	// blank cell
		tempCell = tempRow.insertCell()
		tempCell.innerHTML = '<img src="x.gif" width=1 height=3><br>' + dataList.data[i][3] 
		...
		tempRow.insertCell()	// blank cell
		tempCell = tempRow.insertCell()
		tempCell.innerHTML = dataList.data[i][4]
		tempCell.className = fntSmall
		tempCell.vAlign = 'bottom'
	    ...
	    tempRow.insertCell()	// blank cell
		tempCell = tempRow.insertCell()
		tempCell.innerHTML = dataList.data[i][5]
		tempCell.className = fntSmall
		tempCell.vAlign = 'bottom'
